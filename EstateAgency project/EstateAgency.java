...
public class EstateAgency implements PropertyTransaction {
	 ...
	 public static void addNewProperty(String[] Attributes) {
		 Apartment apt = PropertyFactory.getApartment(Attributes);
		 objectList.add(apt);
	 }
	 
	 public static void addNewProperty(String[] Attributes, String floor) {
		 House house = PropertyFactory.getHouse(Attributes);
		 objectList.add(house);
	 }
	 
	 public void addNewProperties() throws ParserConfigurationException, SAXException, IOException{
		Attr=getPriorityOrderAttribute();
		startPropertyTransaction();
